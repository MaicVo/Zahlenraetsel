...
pruefenButton.onclick = function (mouseEvent) {
    ...
    if (anzahlVersuche > 0) {
        ...
        if (ausgedachteZahl == eingabe.valueAsNumber) {
            ...
            restVersuche.innerHTML = anzahlVersuche.toString();
            if (anzahlVersuche == 0) {
                ausgabe.innerHTML = "Puh Lisa, gerade noch so! Die gesuchte Zahl ist in der Tat " + ausgedachteZahl + "! Als Belohnung erhälst einen Hinweis auf das was du dir erhoffst: Als Nachkomme von Mutter, Vater und Oma verging einige Zeit bis das Erstgeborene das Licht der Welt erblickte. Sie freuten sich auf diesen Tag. Die Sonne strahlte und der Mond leuchtete. Ein Zeitpunkt im Frühling, ach wie es draußen blühte. Einige Weihnachtsfeste und Glühweine später fragte man sich: Wie sahen wohl die drei Monde zur ihrer Zeit aus?";
            }
...
function zufallsTippOhneWiederholung(zahl) {
